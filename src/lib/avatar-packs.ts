...
export const RASTER_AVATAR_PACKS: Record<RasterAvatarSkin, RasterAvatarPack> = {
  ...
  "oru-gujia": {
    ...
    id: "oru-gujia",
    name: "Uru & Gujia",
    description: "Personal two-cat avatar pack based on Uru and Gujia.",
    basePath: "/avatars/oru-gujia",
    thumbnail: "/avatars/oru-gujia/thumbnail.png",
    art: { w: 178, h: 171, head: 171 },
  ...
  "spark-buddy": {
    ...
    id: "spark-buddy",
    name: "Pikachu",
    description: "Electric yellow avatar with lively 2.5D poses.",
    basePath: "/avatars/spark-buddy",
    thumbnail: "/avatars/spark-buddy/thumbnail.png",
    art: { w: 134, h: 147, head: 147 },

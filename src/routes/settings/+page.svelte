              ...
              <div class="skin-tile-preview">
                {#if opt.id === "off"}
                  <svg viewBox="0 0 80 80" width="60" height="60" aria-hidden="true">
                    <circle cx="40" cy="40" r="28" fill="none" stroke="var(--text-secondary)" stroke-width="2" stroke-dasharray="3 3" />
                    <line x1="20" y1="20" x2="60" y2="60" stroke="var(--text-secondary)" stroke-width="2" />
                  </svg>
                {:else if opt.id === "stylized"}
                  <!-- mini paperclip with eyes -->
                  <svg viewBox="0 0 60 80" width="44" height="60" aria-hidden="true">
                    ...
                    <ellipse cx="22" cy="25" rx="3" ry="3.5" fill="#fff" stroke="currentColor" stroke-width="1.2"/>
                    <circle cx="22" cy="26" r="1.4" fill="currentColor"/>
                    <ellipse cx="32" cy="25" rx="3" ry="3.5" fill="#fff" stroke="currentColor" stroke-width="1.2"/>
                    <circle cx="32" cy="26" r="1.4" fill="currentColor"/>
                  </svg>
                {:else if opt.id === "real-clippy"}
                  <!-- original Microsoft Clippy mini — chunkier proportions -->
                  <svg viewBox="0 0 70 80" width="50" height="60" aria-hidden="true">
                    <path d="M 27 12 C 27 6, 43 6, 43 12 L 43 64 C 43 74, 19 74, 19 60 L 19 28 C 19 20, 33 20, 33 28 L 33 56"
                          fill="none" stroke="#2c2c2e" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M 17 20 Q 22 16, 28 20 L 27 22 Q 22 19, 18 22 Z" fill="#2c2c2e"/>
                    <path d="M 30 20 Q 35 16, 41 20 L 40 22 Q 35 19, 31 22 Z" fill="#2c2c2e"/>
                    <ellipse cx="23" cy="28" rx="4" ry="4.5" fill="#fff" stroke="#2c2c2e" stroke-width="1.4"/>
                    <ellipse cx="23" cy="29" rx="1.5" ry="2" fill="#2c2c2e"/>
                    <ellipse cx="37" cy="28" rx="4" ry="4.5" fill="#fff" stroke="#2c2c2e" stroke-width="1.4"/>
                    <ellipse cx="37" cy="29" rx="1.5" ry="2" fill="#2c2c2e"/>
                  </svg>
                {:else if opt.id === "chippy"}
                  <!-- chippy potato chip mini -->
                  <svg viewBox="0 0 70 70" width="58" height="58" aria-hidden="true">
                    <defs>
                      <linearGradient id="chip-mini" x1="0" y1="0" x2="0" y2="1">
                    ...
                    <path d="M 12 35 C 8 18, 30 10, 35 20 C 40 10, 62 18, 58 35 C 62 52, 40 60, 35 50 C 30 60, 8 52, 12 35 Z"
                          fill="url(#chip-mini)" stroke="#7a4d12" stroke-width="1.5"/>
